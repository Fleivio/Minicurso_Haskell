...
- [Funções de alta ordem em Javascript](https://www.freecodecamp.org/news/higher-order-functions-in-javascript-explained/)
- [Funções de alta ordem em Javascript (2) ](https://www.freecodecamp.org/news/higher-order-functions-explained/)
- [Funções de alta ordem em Python (2) ](https://www.freecodecamp.org/news/first-class-functions-and-closures-in-python/)
